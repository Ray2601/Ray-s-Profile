...
export const stats = [
  ...
  { value: '3', label: '搭建上线 Agent' },
  { value: '1st', label: '产品大赛名次(占位)' },
]
...
export const projects: Project[] = [
  {
    ...
    description: '一个从微信群接龙开始，最后真的跑起来的校园外卖平台。我们连接学生、校外商家和配送骑手，也在真实订单里一点点把产品磨出来。',
  ...
  },
  {
    ...
    description: '从问题定义、产品设计到开发可交互 Demo 全程独立完成，最终入围 34 强复赛（2026.05 — 2026.06）。',
  ...
  },
  {
    ...
    description:
      '把一张普通图片，变成可交互的 3D 模型。完成从交互式抠像、图像补全到 3D 生成的一体化流程。',
